...
class SearchBlock extends Component {
  ...
  submit = () => {
    if(this.state.patvirtinta && !!this.state.tagas && !!this.state.vardas && !!this.state.komentaras ){
      ...
      document.getElementById('error').innerHTML = "Neužpildėte visų viršuje esančių laukelių!";
    }
    ...
    return (
      <div className="container-fluid pt-3  sticky-top sticky-offset" >
          ...
          <div className="bg-white shadow" style={{borderRadius: "10px"}}>
            ...
            <div style={{color: "#dc3546", padding: "5px", fontSize: "14px", paddingBottom: "10px"}} id="error"></div>
            <button onClick={this.submit} id="submit" className="btn btn-primary auto mb-4">Skelbti</button>
